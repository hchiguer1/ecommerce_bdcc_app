package net.chiguer.orderservices;

import net.chiguer.orderservices.entities.Order;
import net.chiguer.orderservices.entities.OrderStatus;
import net.chiguer.orderservices.entities.ProductItem;
import net.chiguer.orderservices.repositories.OrderRepository;
import net.chiguer.orderservices.repositories.ProductItemRepository;
import net.chiguer.orderservices.restClient.InventoryRestClient;
